...
print("Once there were 5 colorful,",eye_color,"cats that lived together with their master, a mean old man.  ")
...
print("The cat,",middle_name,"starts crying afraid that they would get caught.")
print("As they came aroung the corner, they saw a sign that read,",dream_vacation,"straight ahead! ")
print("As the cats thought about,",favorite_fish,"the cats change into the color of,",favorite_color,"helping them to escape")
